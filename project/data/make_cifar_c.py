...
def run_flow():
    ...
    for method_name in d.keys():
        ...
        np.save('/data/p288722/datasets/cifar/CIFAR-10-C-EnhancedSeverity/' + d[method_name].__name__ + '.npy',
                np.array(cifar_c).astype(np.uint8))

        np.save('/data/p288722/datasets/cifar/CIFAR-10-C-EnhancedSeverity/labels.npy',
