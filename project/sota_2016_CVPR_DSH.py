...
class Classifier(pl.LightningModule):
    ...
    def validation_epoch_end(self, outputs) -> None:
        ...
        train_score = compute_map_score(trn_hash_codes, trn_ground_truths, trn_hash_codes, trn_ground_truths, self.device)
        test_score = compute_map_score(trn_hash_codes, trn_ground_truths, test_hash_codes, test_ground_truths, self.device)
